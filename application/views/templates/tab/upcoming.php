<div class="vticker1" style="min-height: 280px;">
                <ul>
                    ...
                    <li style="list-style: none; padding: 0px">
                            <div class="news-grid" style="padding: 10px;border-bottom: #C0C0C0 dotted 1px">
                                ...
                                <p style="margin-bottom: 5px;"><?php echo $item->UPCOMING_EVENT; ?></p>
                                <div title="Source Title" style="color: #ffffff; float: left">
                                    <?php if ($item->PATH_ATTACH != 'x') { ?>
                                        <a href="<?php echo ADMIN___ . '/assets/newsdetail/' . $item->PATH_ATTACH; ?>" target="_blank" style="text-decoration: none; color:#fff; background: #9090DD; padding: 2px; border-radius: 3px; font-size: 10px">click for detail</a>
                                    <?php } ?>
                                </div>
